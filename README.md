...
The biggest difference between .forEach() and .map() is that .forEach executes the given function on each element of an array. .map() creates a new array, executing the function on each
